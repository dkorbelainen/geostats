    ...
    return [
        {
            ...
            "rating_moving": row.RatingSnapshot.rating_moving if row.RatingSnapshot else None,
            "rating_nomove": row.RatingSnapshot.rating_nomove if row.RatingSnapshot else None,
            "rating_nmpz": row.RatingSnapshot.rating_nmpz if row.RatingSnapshot else None,
